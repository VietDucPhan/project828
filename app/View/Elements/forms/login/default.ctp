...
<?php echo $this->Session->flash('auth'); ?>
    <div class="row">
      <div class="large-12">
        <?php echo $this -> Form -> input('email', array('label' => __('Email'), 'required' => 'required', 'div' => false)); ?>
      </div>
      <div class="large-12">
        <?php echo $this -> Form -> input('password', array('label' => __('password'), 'required' => 'required', 'div' => false)); ?>
      </div>
      <div class="large-12">
