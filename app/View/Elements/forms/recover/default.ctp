<?php
echo $this -> Form -> create(null, array('url' => array('controller' => 'users', 'action' => 'recover'), 'data-abide'));
if(empty($code)){
  $code = '';
}
?>
      ...
      <div class="large-12">
          <?php echo $this -> Form -> input('repassword',array('label' => __('Retype your new password'),'required'=>'required','div'=>false,'data-equalto'=>'newPassword','type'=>'password')); ?>
